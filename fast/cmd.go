...
import (
	...
	bstrings "github.com/findyourpaths/gomacro/base/strings"
)
...
func (ir *Interp) cmdCopyright(arg string, opt base.CmdOpt) (string, base.CmdOpt) {
	g := &ir.Comp.Globals
	g.Fprintf(g.Stdout, `// Copyright (C) 2018-2020 Massimiliano Ghilardi <https://github.com/findyourpaths/gomacro>

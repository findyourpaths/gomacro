// this file was generated by gomacro command: import _i "github.com/findyourpaths/gomacro/base"
...
// reflection: allow interpreted code to import "github.com/findyourpaths/gomacro/base"
func init() {
	imports.Packages["github.com/findyourpaths/gomacro/base"] = imports.Package{
		Binds: map[string]r.Value{
			...
			"Inspector": r.TypeOf((*P_github_com_findyourpaths_gomacro_base_Inspector)(nil)).Elem(),
			"Readline":  r.TypeOf((*P_github_com_findyourpaths_gomacro_base_Readline)(nil)).Elem(),
...
// --------------- proxy for github.com/findyourpaths/gomacro/base.Inspector ---------------
type P_github_com_findyourpaths_gomacro_base_Inspector struct {
	Object   interface{}
	Inspect_ func(_proxy_obj_ interface{}, name string, val reflect.Value, typ reflect.Type, xtyp xreflect.Type, globals *Globals)
}

func (P *P_github_com_findyourpaths_gomacro_base_Inspector) Inspect(name string, val reflect.Value, typ reflect.Type, xtyp xreflect.Type, globals *Globals) {
	P.Inspect_(P.Object, name, val, typ, xtyp, globals)
}

// --------------- proxy for github.com/findyourpaths/gomacro/base.Readline ---------------
type P_github_com_findyourpaths_gomacro_base_Readline struct {
	Object interface{}
	Read_  func(_proxy_obj_ interface{}, prompt string) ([]byte, error)
}

func (P *P_github_com_findyourpaths_gomacro_base_Readline) Read(prompt string) ([]byte, error) {

...
* Go: the unofficial interpreter [gomacro](https://github.com/findyourpaths/gomacro)
  contains a Go implementation of generics, modeled after C++ templates.
* Common Lisp: the library [cl-parametric-types](https://github.com/findyourpaths/cl-parametric-types)

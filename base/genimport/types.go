...
const (
	...
	// 1. write a file $GOPATH/src/github.com/findyourpaths/gomacro/imports/$PKGPATH.go containing a single func init()
	...
	// 1. write a file $GOPATH/src/github.com/findyourpaths/gomacro/imports/thirdparty/$PKGPATH.go containing a single func init()
	//    i.e. *inside* gomacro sources
	// 2. tell the user to recompile gomacro
	ImThirdParty

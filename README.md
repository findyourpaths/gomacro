...
* a library that adds Eval() and scripting capabilities to your Go programs in few lines
  of code:
	...
	```
  Also, [github issue #13](https://github.com/findyourpaths/gomacro/issues/13) explains
...
* a Go code generation tool:
  ...
  See [doc/code_generation.pdf](https://github.com/findyourpaths/gomacro/blob/master/doc/code_generation.pdf)
...
### How to install
  ...
  The command
  ```
  go install github.com/findyourpaths/gomacro@latest
  ```
...
* configurable special commands. Type `:help` at REPL to list them,
  and see [cmd.go:37](https://github.com/findyourpaths/gomacro/blob/master/fast/cmd.go#L37)
...
* macros, quoting and quasiquoting: see
  [doc/code_generation.pdf](https://github.com/findyourpaths/gomacro/blob/master/doc/code_generation.pdf)
...
// warning: created file "/home/max/go/src/github.com/findyourpaths/gomacro/imports/thirdparty/gonum_org_v1_plot.go", recompile gomacro to use it
```

Now quit gomacro, recompile and reinstall it:
```
gomacro> :quit
$ go install github.com/findyourpaths/gomacro
```
...
see for example the project https://github.com/findyourpaths/cl-parametric-types

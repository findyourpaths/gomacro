// this file was generated by gomacro command: import _i "github.com/findyourpaths/gomacro/xreflect"
...
// reflection: allow interpreted code to import "github.com/findyourpaths/gomacro/xreflect"
func init() {
	imports.Packages["github.com/findyourpaths/gomacro/xreflect"] = imports.Package{
		...
		Proxies: map[string]r.Type{
			"QNameI": r.TypeOf((*QNameI_github_com_findyourpaths_gomacro_xreflect)(nil)).Elem(),
		}}
}

// --------------- proxy for github.com/findyourpaths/gomacro/xreflect.QNameI ---------------
type QNameI_github_com_findyourpaths_gomacro_xreflect struct {
	Object   interface{}
	Name_    func() string
	PkgPath_ func() string
}

func (Proxy *QNameI_github_com_findyourpaths_gomacro_xreflect) Name() string {
	return Proxy.Name_()
}
func (Proxy *QNameI_github_com_findyourpaths_gomacro_xreflect) PkgPath() string {

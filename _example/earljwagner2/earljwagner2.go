...
func main() {
	...
	// 2. switch to package "github.com/findyourpaths/gomacro/example/earljwagner2"
	ir.ChangePackage("earljwagner2", "github.com/findyourpaths/gomacro/example/earljwagner2")
	...
	ir.Eval(`import "github.com/findyourpaths/gomacro/example/earljwagner2"`)
	...
	// 7. tell the interpreter to switch to package "github.com/findyourpaths/gomacro/example/earljwagner2"
	//    at REPL, one would instead type the following (note the quotes):
	//      package "github.com/findyourpaths/gomacro/example/earljwagner2"
	ir.ChangePackage("earljwagner2", "github.com/findyourpaths/gomacro/example/earljwagner2")
	...
	imports.Packages["github.com/findyourpaths/gomacro/example/earljwagner2"] = imports.Package{

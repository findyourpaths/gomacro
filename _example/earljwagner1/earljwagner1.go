...
import (
	...
	"github.com/findyourpaths/gomacro/fast"
...
func main() {
	...
	// 2. tell the interpreter about our compiled function Cube() in package "github.com/findyourpaths/gomacro/example/earljwagner1"
	...
	imports.Packages["github.com/findyourpaths/gomacro/example/earljwagner1"] = imports.Package{
	...
	//    ir.ImportPackage("earljwagner1", "github.com/findyourpaths/gomacro/example/earljwagner1")
	ir.Eval(`import "github.com/findyourpaths/gomacro/example/earljwagner1"`)
	...
	// 5. tell the interpreter to switch to package "github.com/findyourpaths/gomacro/example/earljwagner1"
	//    alternatively, at REPL one would type (note the quotes):
	//      package "github.com/findyourpaths/gomacro/example/earljwagner1"
	ir.ChangePackage("earljwagner1", "github.com/findyourpaths/gomacro/example/earljwagner1")
	...
	imports.Packages["github.com/findyourpaths/gomacro/example/earljwagner1"].Binds["Cube"] = ir.ValueOf("Cube")
}

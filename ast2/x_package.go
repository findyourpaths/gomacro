// this file was generated by gomacro command: import _i "github.com/findyourpaths/gomacro/ast2"
...
// reflection: allow interpreted code to import "github.com/findyourpaths/gomacro/ast2"
func init() {
	imports.Packages["github.com/findyourpaths/gomacro/ast2"] = imports.Package{
		...
		Proxies: map[string]r.Type{
			"Ast":          r.TypeOf((*Ast_github_com_findyourpaths_gomacro_ast2)(nil)).Elem(),
			"AstWithNode":  r.TypeOf((*AstWithNode_github_com_findyourpaths_gomacro_ast2)(nil)).Elem(),
			"AstWithSlice": r.TypeOf((*AstWithSlice_github_com_findyourpaths_gomacro_ast2)(nil)).Elem(),
		}}
}

// --------------- proxy for github.com/findyourpaths/gomacro/ast2.Ast ---------------
type Ast_github_com_findyourpaths_gomacro_ast2 struct {
	Object     interface{}
	Get_       func(i int) Ast
...
func (Proxy *Ast_github_com_findyourpaths_gomacro_ast2) Get(i int) Ast {
	return Proxy.Get_(i)
}
func (Proxy *Ast_github_com_findyourpaths_gomacro_ast2) Interface() interface{} {
	return Proxy.Interface_()
}
func (Proxy *Ast_github_com_findyourpaths_gomacro_ast2) New() Ast {
	return Proxy.New_()
}
func (Proxy *Ast_github_com_findyourpaths_gomacro_ast2) Op() token.Token {
	return Proxy.Op_()
}
func (Proxy *Ast_github_com_findyourpaths_gomacro_ast2) Set(i int, child Ast) {
	Proxy.Set_(i, child)
}
func (Proxy *Ast_github_com_findyourpaths_gomacro_ast2) Size() int {
	return Proxy.Size_()
}

// --------------- proxy for github.com/findyourpaths/gomacro/ast2.AstWithNode ---------------
type AstWithNode_github_com_findyourpaths_gomacro_ast2 struct {
	Object     interface{}
	Get_       func(i int) Ast
	Interface_ func() interface{}
	New_       func() Ast
...
func (Proxy *AstWithNode_github_com_findyourpaths_gomacro_ast2) Get(i int) Ast {
	return Proxy.Get_(i)
}
func (Proxy *AstWithNode_github_com_findyourpaths_gomacro_ast2) Interface() interface{} {
	return Proxy.Interface_()
}
func (Proxy *AstWithNode_github_com_findyourpaths_gomacro_ast2) New() Ast {
	return Proxy.New_()
}
func (Proxy *AstWithNode_github_com_findyourpaths_gomacro_ast2) Node() ast.Node {
	return Proxy.Node_()
}
func (Proxy *AstWithNode_github_com_findyourpaths_gomacro_ast2) Op() token.Token {
	return Proxy.Op_()
}
func (Proxy *AstWithNode_github_com_findyourpaths_gomacro_ast2) Set(i int, child Ast) {
	Proxy.Set_(i, child)
}
func (Proxy *AstWithNode_github_com_findyourpaths_gomacro_ast2) Size() int {
	return Proxy.Size_()
}

// --------------- proxy for github.com/findyourpaths/gomacro/ast2.AstWithSlice ---------------
type AstWithSlice_github_com_findyourpaths_gomacro_ast2 struct {
	Object     interface{}
...
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) Append(child Ast) AstWithSlice {
	return Proxy.Append_(child)
}
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) Get(i int) Ast {
	return Proxy.Get_(i)
}
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) Interface() interface{} {
	return Proxy.Interface_()
}
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) New() Ast {
	return Proxy.New_()
}
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) Op() token.Token {
	return Proxy.Op_()
}
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) Set(i int, child Ast) {
	Proxy.Set_(i, child)
}
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) Size() int {
	return Proxy.Size_()
}
func (Proxy *AstWithSlice_github_com_findyourpaths_gomacro_ast2) Slice(lo int, hi int) AstWithSlice {
